...
//     }
//   };
//   const QuestionAnswerPage = ({ isSidebarCollapsed }) => {

//   return (

//     <div className="question-answer-content">
//           <div className={`question-answer-page ${isSidebarCollapsed ? 'collapsed' : ''}`}>
...
function QuestionAnswerPage({ isSidebarCollapsed }) {
  // Sidebar 상태 전달
  const location = useLocation();
  const navigate = useNavigate();
  const { questionId } = useParams();
